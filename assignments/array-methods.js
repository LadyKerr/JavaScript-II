...
// Problem 1
//List the email addresses of each runner for the marketing team to easily access
const runnerEmail = [];
runners.forEach(function(runner) {
...
// Problem 2
// List the first names and company names of each runner
const runnerCo = runners.map(runner => `${runner.first_name} works with ${runner.company_name}`);
console.log(runnerCo);

// Problem 3
// List out all runners with small shirt sizes
let smallShirts = runners.filter(function(runner) {
